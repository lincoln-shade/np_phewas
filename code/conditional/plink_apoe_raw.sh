...
# ADNI
adni_prefix=/data_global/ADNI/ADNI_TOPMed_fromHohman_20211214/ADNI_NHW_imputed_final
find_apoe_varids "$adni_prefix".bim > tmp/adni_apoe_varids.tmp

plink \
  --bfile "$adni_prefix" \
  --chr 19 \
  --extract tmp/adni_apoe_varids.tmp \
  --recode A \
  --out data/adni/apoe_snps
